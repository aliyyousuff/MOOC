# Implement the Nearest Neighbors Heuristic for the Traveling Salesman Problem. Your algorithm should start with the vertex number 0,
# and then each time select the closest vertex among the ones which don't yet belong to the cycle.
