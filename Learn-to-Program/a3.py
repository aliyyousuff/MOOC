...
def board_contains_word_in_column(board, word):
    ...
    False
    >>> board_contains_word_in_column([ ['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B'], ['X', 'S', 'O', 'B']],'TO')
    True
    >>> board_contains_word_in_column([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B'], ['W', 'C', 'H', 'J']],'TO')
    True

    """
    for col_ind in range(len(board[0])):
        if word in make_str_from_column(board, col_ind):
            return True
    return False
